...
class TestIdentificationToolkit(unittest.TestCase):
    ...
    #     NOTE: This test is disabled because the functions 'identify_at_point' and
    #     'generate_model_bank' have been refactored into the IdentificationToolkit class.
    #     This test needs to be rewritten to test the new class-based implementation.
    #     """
    #     base_config = {
    #         "components": {
    #             "StVenantModel": {
